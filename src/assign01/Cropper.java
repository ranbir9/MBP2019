...
public class Cropper {
    public static void main(String[] args)  {
        ...
        try {
            ...
            //gi.cropped(0, 135, 540 ,405).savePNG(new File("outputImageC2.png"));
            gi.mirrored().savePNG(new File("outputImageSQ.png"));
            //gi.squarified().normalized().mirrored().savePNG(new File("outputImage" + count + ".png"));
