...
public class StudentHashDemo {
	...
	public static void main(String[] args) {
		...
		System.out.println("size: " + studentGpaTable.size());

		//**** test */
		System.out.println(studentGpaTable.toString());
		List<MapEntry<StudentBadHash, Double>> entries = studentGpaTable.entries();
